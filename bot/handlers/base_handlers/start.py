...
from bot.keyboards.admin_keyboards.reply.main_keyboards import (
    main_keyboard as main_admin_keyboard
)
from bot.keyboards.user_keyboards.reply.main_keyboards import (
    main_keyboard as main_user_keyboard
)
...
async def handle_start(message: Message):
    ...
    if user.is_admin:
        return await message.answer(
            admin_welcome_message, reply_markup=main_admin_keyboard
        )
    else:
        return await message.answer(
            welcome_message, reply_markup=main_user_keyboard
        )
