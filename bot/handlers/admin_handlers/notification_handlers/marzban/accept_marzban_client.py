...
from bot.templates.user_templates.message_templates import (
    you_are_successfully_connected_message, wait_for_admin_message
)
...
from bot.templates.admin_templates.errors_templates import (
    marzban_user_add_error, marzban_link_get_error, adding_data_error
)
from bot.templates.admin_templates.messages_templates import (
    marzban_user_added_message, pick_table_for_client_message, request_to_connect_message
)
...
from bot.templates.admin_templates.errors_templates import (
    connection_does_not_exist_error, client_does_not_exists_error
)
...
async def handle_payment_check_completed(callback: CallbackQuery):
    """Handles payment check completion for connecting clients to Marzban"""
