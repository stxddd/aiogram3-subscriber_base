...
def table_edit_error(table_name):
    return f"❌ Ошибка при измении имени таблицы «{table_name}»"
...
exceeded_the_limit_on_the_table_download_error = (
    "❌ Вы достигли лимита скачиваний на сегодня. 5/5"
)
...
table_already_exists_error = (
    "❌ Ошибка: таблица с такиим названием уже существует. Введите заново."
)
