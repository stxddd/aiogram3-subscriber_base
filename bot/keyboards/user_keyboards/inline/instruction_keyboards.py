    ...
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(
                text=android_os_text, callback_data="Android_get_instruction"
            )
        ],
        [
            InlineKeyboardButton(
                text=windows_os_text, callback_data="Windows_get_instruction"
            )
        ],
        [
        ...
        [
            InlineKeyboardButton(
                text=android_tv_os_text, callback_data="AndroidTV_get_instruction"
            )
        ],
    ],
