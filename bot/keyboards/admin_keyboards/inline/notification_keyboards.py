...
async def get_marzban_access_keyboard(connection_id: int):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=accept_text, callback_data=f"accept_marzban_{connection_id}"
                ),
                InlineKeyboardButton(
                    text=reject_text, callback_data=f"reject_marzban_{connection_id}"
                ),
            ]
        ]
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text=accept_text,
                    callback_data=f"accept_extend_{connection_id}_{months}_{price}",
                ),
                InlineKeyboardButton(
                    text=reject_text, callback_data=f"reject_extend_{connection_id}"
                ),
            ]
        ]
    )
